...
<div class="py-6 sm:py-8 md:py-10 lg:py-12">
    <div class="max-w-xl sm:max-w-3xl md:max-w-5xl lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-blue-50 overflow-hidden shadow-xl sm:rounded-lg"> {{-- Changed to a very light blue --}}
            <div class="p-4 sm:p-6 lg:p-8 bg-blue-50 border-b border-gray-200"> {{-- Also update inner div --}}

                {{-- Lecturer's Name / Welcome Message --}}
                @auth
                    @php
                        $user = Auth::user();
                    @endphp
                    <div class="mb-6">
                        <p class="text-gray-600 text-lg sm:text-xl font-medium">Welcome,</p>
                        <h1 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-indigo-700 leading-tight">
                            {{ $user->name ?? 'Lecturer' }}
                        </h1>
                        <p class="text-gray-500 text-sm sm:text-base mt-1">Here's an overview of your units and today's attendance.</p>
                    </div>
                @endauth

                <h2 class="text-xl sm:text-2xl md:text-3xl font-extrabold text-gray-900 mb-4 sm:mb-6">Lecturer Dashboard</h2>
                ...
                <div class="bg-gray-50 p-5 sm:p-6 md:p-8 rounded-xl shadow-inner border border-gray-100 mb-8 lg:mb-10">
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-5 border-b-2 pb-3 border-indigo-300 flex items-center">
                ...
                @if(!$todayAttendances->isEmpty())
                    ...
                    <div class="bg-gray-100 p-5 sm:p-6 rounded-xl shadow-inner border border-gray-200">
                        @foreach($todayAttendances as $unitId => $attendances)
                            ...
                            @endphp
                            <div class="mb-5 sm:mb-6 border-b border-gray-300 pb-4 last:border-b-0">
