                    ...
                    <form action="{{ route('admin.courses.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="course_type" id="course_type"
                                ...
                                <option value="Masters" {{ old('course_type') == 'Masters' ? 'selected' : '' }}>Masters</option>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <a href="{{ route('admin.courses.index') }}" class="ml-4 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-md transition duration-150 ease-in-out">
                                Cancel
                            </a>
                        </div>
                    </form>
