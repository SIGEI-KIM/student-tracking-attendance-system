...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- Fallback for local development if Vite isn't running. In production, Vite assets should always be built. --}}
    ...
    <body class="font-sans antialiased text-gray-900 dark:text-gray-100">
        <div class="relative min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 selection:bg-indigo-500 selection:text-white">
            ...
            {{-- Hero Section --}}
            <main class="w-full max-w-7xl mx-auto px-6 lg:px-8 py-20 flex flex-col lg:flex-row items-center justify-center gap-12">
                <div class="text-center lg:text-left lg:w-1/2">
                    <h1 class="text-5xl lg:text-6xl font-extrabold text-indigo-700 dark:text-indigo-400 leading-tight mb-4 animate-fade-in-down">
                        <i class="fas fa-user-check mr-4 text-indigo-500 dark:text-indigo-300"></i>
                        Effortless Student Attendance Tracking
                    </h1>
                    <p class="text-xl lg:text-2xl text-gray-700 dark:text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0 animate-fade-in delay-200">
                        Streamline attendance management for students and lecturers. Track presence, monitor progress, and ensure accountability with ease.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in delay-400">
                        <a href="{{ route('login') }}"
                           class="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-full shadow-lg text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform transition duration-300 ease-in-out hover:scale-105">
                            <i class="fas fa-sign-in-alt mr-3"></i>
                            Get Started
                        </a>
                        <a href="#features"
                           class="inline-flex items-center justify-center px-8 py-4 border border-indigo-600 dark:border-indigo-400 text-base font-medium rounded-full text-indigo-700 dark:text-indigo-400 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform transition duration-300 ease-in-out hover:scale-105">
                ...
                <div class="lg:w-1/2 flex justify-center lg:justify-end animate-fade-in-right delay-600">
                    {{-- Placeholder for an image or illustration --}}
                    {{-- You can replace this with an actual image, e.g., <img src="{{ asset('images/attendance-illustration.svg') }}" alt="Attendance Tracking" class="max-w-full h-auto rounded-lg shadow-2xl"> --}}
                    <div class="bg-indigo-500 dark:bg-indigo-700 w-96 h-96 rounded-full flex items-center justify-center shadow-2xl animate-pulse-light">
                        <i class="fas fa-calendar-check text-white text-9xl"></i>
                    </div>
                </div>
            </main>

            {{-- Features Section --}}
            <section id="features" class="w-full max-w-7xl mx-auto px-6 lg:px-8 py-20 bg-white dark:bg-gray-800 rounded-lg shadow-xl my-12">
                <h2 class="text-4xl font-extrabold text-center text-gray-800 dark:text-white mb-12">Key Features</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {{-- Feature 1 --}}
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md text-center transform hover:scale-105 transition duration-300 ease-in-out">
                        <i class="fas fa-clipboard-list text-5xl text-blue-500 dark:text-blue-300 mb-4"></i>
                        <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Real-time Tracking</h3>
                        <p class="text-gray-600 dark:text-gray-300">Monitor student attendance as it happens, ensuring up-to-date records.</p>
                    </div>
                    {{-- Feature 2 --}}
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md text-center transform hover:scale-105 transition duration-300 ease-in-out">
                        <i class="fas fa-chart-line text-5xl text-green-500 dark:text-green-300 mb-4"></i>
                        <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Detailed Reports</h3>
                        <p class="text-gray-600 dark:text-gray-300">Generate comprehensive attendance reports for analysis and insights.</p>
                    </div>
                    {{-- Feature 3 --}}
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md text-center transform hover:scale-105 transition duration-300 ease-in-out">
                        <i class="fas fa-bell text-5xl text-yellow-500 dark:text-yellow-300 mb-4"></i>
                        <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Automated Notifications</h3>
                        <p class="text-gray-600 dark:text-gray-300">Receive alerts for absentee students or attendance milestones.</p>
                    </div>
                    {{-- Feature 4 --}}
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md text-center transform hover:scale-105 transition duration-300 ease-in-out">
                        <i class="fas fa-user-friends text-5xl text-purple-500 dark:text-purple-300 mb-4"></i>
                        <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Student & Lecturer Portals</h3>
                        <p class="text-gray-600 dark:text-gray-300">Dedicated interfaces for both students and lecturers for easy access.</p>
                    </div>
                    {{-- Feature 5 --}}
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md text-center transform hover:scale-105 transition duration-300 ease-in-out">
                        <i class="fas fa-mobile-alt text-5xl text-red-500 dark:text-red-300 mb-4"></i>
                        <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Mobile Friendly</h3>
                        <p class="text-gray-600 dark:text-gray-300">Access and manage attendance seamlessly on any device.</p>
                    </div>
                    {{-- Feature 6 --}}
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md text-center transform hover:scale-105 transition duration-300 ease-in-out">
                        <i class="fas fa-shield-alt text-5xl text-teal-500 dark:text-teal-300 mb-4"></i>
                        <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Secure & Reliable</h3>
                        <p class="text-gray-600 dark:text-gray-300">Your data is safe and secure with robust security measures.</p>
                    </div>
                </div>
            </section>
        ...
        <style>
            ...
            @keyframes pulseLight {
                ...
                50% {
                    box-shadow: 0 0 0 1.5rem rgba(99, 102, 241, 0); /* Expanded and faded */
                }
            }
            ...
            .animate-pulse-light {
                animation: pulseLight 2s infinite cubic-bezier(0.4, 0, 0.6, 1);
            }

            /* Delay utility for Tailwind's animation utility */
            ...
            #app { /* if you have a #app div, ensure it grows */
                flex-grow: 1;
            }
        </style>
    </body>
